...
var _exercism$elm$Console$bgWhite = function (str) {
	return A2(
		_elm_lang$core$String$join,
		'',
		{
...
var _exercism$elm$Console$bgCyan = function (str) {
	return A2(
		_elm_lang$core$String$join,
		'',
		{
...
var _exercism$elm$Console$bgMagenta = function (str) {
	return A2(
		_elm_lang$core$String$join,
		'',
		{
...
var _exercism$elm$Console$bgBlue = function (str) {
	return A2(
		_elm_lang$core$String$join,
		'',
		{
...
var _exercism$elm$Console$bgYellow = function (str) {
	return A2(
		_elm_lang$core$String$join,
		'',
		{
...
var _exercism$elm$Console$bgGreen = function (str) {
	return A2(
		_elm_lang$core$String$join,
		'',
		{
...
var _exercism$elm$Console$bgRed = function (str) {
	return A2(
		_elm_lang$core$String$join,
		'',
		{
...
var _exercism$elm$Console$bgBlack = function (str) {
	return A2(
		_elm_lang$core$String$join,
		'',
		{
...
var _exercism$elm$Console$white = function (str) {
	return A2(
		_elm_lang$core$String$join,
		'',
		{
...
var _exercism$elm$Console$cyan = function (str) {
	return A2(
		_elm_lang$core$String$join,
		'',
		{
...
var _exercism$elm$Console$magenta = function (str) {
	return A2(
		_elm_lang$core$String$join,
		'',
		{
...
var _exercism$elm$Console$blue = function (str) {
	return A2(
		_elm_lang$core$String$join,
		'',
		{
...
var _exercism$elm$Console$yellow = function (str) {
	return A2(
		_elm_lang$core$String$join,
		'',
		{
...
var _exercism$elm$Console$green = function (str) {
	return A2(
		_elm_lang$core$String$join,
		'',
		{
...
var _exercism$elm$Console$red = function (str) {
	return A2(
		_elm_lang$core$String$join,
		'',
		{
...
var _exercism$elm$Console$black = function (str) {
	return A2(
		_elm_lang$core$String$join,
		'',
		{
...
var _exercism$elm$Console$colorsInverted = function (str) {
	return A2(
		_elm_lang$core$String$join,
		'',
		{
...
var _exercism$elm$Console$underline = function (str) {
	return A2(
		_elm_lang$core$String$join,
		'',
		{
...
var _exercism$elm$Console$bold = function (str) {
	return A2(
		_elm_lang$core$String$join,
		'',
		{
...
var _exercism$elm$Console$dark = function (str) {
	return A2(
		_elm_lang$core$String$join,
		'',
		{
...
var _exercism$elm$Console$plain = function (str) {
	return A2(
		_elm_lang$core$String$join,
		'',
		{
...
var _exercism$elm$Native_RunTest = (function() {
  return {
...
var _exercism$elm$Pangram$isPangram = function (str) {
	var hasLetter = function (l) {
		return A2(
			_elm_lang$core$String$contains,
			_elm_lang$core$Basics$toString(
				_elm_lang$core$Char$toLower(l)),
			str);
	};
	return true;
};
...
var _exercism$elm$Test_Reporter_Console$withChar = F2(
	function (icon, str) {
		return A2(
			_elm_lang$core$Basics_ops['++'],
...
var _exercism$elm$Test_Reporter_Console$stat = F2(
	function (label, value) {
		return _exercism$elm$Console_Text$concat(
			{
				ctor: '::',
				_0: _exercism$elm$Console_Text$dark(
					_exercism$elm$Console_Text$plain(label)),
				_1: {
					ctor: '::',
					_0: _exercism$elm$Console_Text$plain(
						A2(_elm_lang$core$Basics_ops['++'], value, '\n')),
					_1: {ctor: '[]'}
				}
			});
	});
var _exercism$elm$Test_Reporter_Console$textToValue = F2(
	function (useColor, txt) {
		return _elm_lang$core$Json_Encode$string(
			A2(_exercism$elm$Console_Text$render, useColor, txt));
	});
var _exercism$elm$Test_Reporter_Console$failureLabelsToText = function (_p0) {
	return _exercism$elm$Console_Text$concat(
		A3(
			_elm_community$elm_test$Test_Runner$formatLabels,
			function (_p1) {
				return _exercism$elm$Console_Text$dark(
					_exercism$elm$Console_Text$plain(
						A2(
							_exercism$elm$Test_Reporter_Console$withChar,
							_elm_lang$core$Native_Utils.chr('↓'),
							_p1)));
			},
			function (_p2) {
				return _exercism$elm$Console_Text$red(
					A2(
						_exercism$elm$Test_Reporter_Console$withChar,
						_elm_lang$core$Native_Utils.chr('✗'),
						_p2));
...
var _exercism$elm$Test_Reporter_Console$todoToChalk = function (message) {
	return _exercism$elm$Console_Text$plain(
		A2(
			_elm_lang$core$Basics_ops['++'],
			'◦ TODO: ',
			A2(_elm_lang$core$Basics_ops['++'], message, '\n\n')));
};
var _exercism$elm$Test_Reporter_Console$todoLabelsToText = function (_p3) {
	return _exercism$elm$Console_Text$concat(
		A3(
			_elm_community$elm_test$Test_Runner$formatLabels,
			function (_p4) {
...
var _exercism$elm$Test_Reporter_Console$todosToText = function (_p6) {
	var _p7 = _p6;
	return _exercism$elm$Console_Text$concat(
		{
			ctor: '::',
			_0: _exercism$elm$Test_Reporter_Console$todoLabelsToText(_p7._0),
			_1: {
				ctor: '::',
				_0: _exercism$elm$Test_Reporter_Console$todoToChalk(_p7._1),
				_1: {ctor: '[]'}
			}
		});
};
var _exercism$elm$Test_Reporter_Console$summarizeTodos = function (_p8) {
	return _exercism$elm$Console_Text$concat(
		A2(_elm_lang$core$List$map, _exercism$elm$Test_Reporter_Console$todosToText, _p8));
};
var _exercism$elm$Test_Reporter_Console$pluralize = F3(
...
var _exercism$elm$Test_Reporter_Console$reportBegin = F2(
	function (useColor, _p9) {
		...
		var prefix = A2(
			...
			A2(
				_elm_lang$core$Basics_ops['++'],
				A3(_exercism$elm$Test_Reporter_Console$pluralize, 'test', 'tests', _p10.testCount),
				A2(
					_elm_lang$core$Basics_ops['++'],
		...
		return _elm_lang$core$Maybe$Just(
			A2(
				_exercism$elm$Test_Reporter_Console$textToValue,
				useColor,
				_exercism$elm$Console_Text$plain(
					A2(
						_elm_lang$core$Basics_ops['++'],
...
var _exercism$elm$Test_Reporter_Console$indent = function (str) {
	return A2(
		_elm_lang$core$String$join,
		'\n',
		A2(
...
var _exercism$elm$Test_Reporter_Console$failureToText = function (_p11) {
	var _p12 = _p11;
	var messageText = _exercism$elm$Console_Text$plain(
		A2(
			_elm_lang$core$Basics_ops['++'],
			'\n',
			A2(
				_elm_lang$core$Basics_ops['++'],
				_exercism$elm$Test_Reporter_Console$indent(_p12.message),
				'\n\n')));
	var _p13 = _p12.given;
...
var _exercism$elm$Test_Reporter_Console$failuresToText = F2(
	function (labels, failures) {
		return _exercism$elm$Console_Text$concat(
			{
				ctor: '::',
				_0: _exercism$elm$Test_Reporter_Console$failureLabelsToText(labels),
				_1: A2(_elm_lang$core$List$map, _exercism$elm$Test_Reporter_Console$failureToText, failures)
			});
	});
var _exercism$elm$Test_Reporter_Console$reportComplete = F2(
	function (useColor, _p14) {
		var _p15 = _p14;
		var _p17 = _p15.labels;
		var _p16 = _p15.outcome;
		switch (_p16.ctor) {
			case 'Passed':
			...
			case 'Failed':
				return A2(
					_exercism$elm$Test_Reporter_Console$textToValue,
					useColor,
					A2(_exercism$elm$Test_Reporter_Console$failuresToText, _p17, _p16._0));
			default:
				return _elm_lang$core$Json_Encode$object(
					{
						ctor: '::',
						...
						_1: {
							...
							_0: {
								...
								_0: 'labels',
								_1: _elm_lang$core$Json_Encode$list(
									A2(_elm_lang$core$List$map, _elm_lang$core$Json_Encode$string, _p17))
							},
							_1: {ctor: '[]'}
						}
					});
...
var _exercism$elm$Test_Reporter_Console$formatDuration = function (time) {
	return A2(
		_elm_lang$core$Basics_ops['++'],
		_elm_lang$core$Basics$toString(time),
		' ms');
};
var _exercism$elm$Test_Reporter_Console$reportSummary = F3(
	function (useColor, _p18, autoFail) {
		var _p19 = _p18;
		var _p25 = _p19.todos;
		var _p24 = _p19.failed;
		var individualTodos = (_elm_lang$core$Native_Utils.cmp(_p24, 0) > 0) ? _exercism$elm$Console_Text$plain('') : _exercism$elm$Test_Reporter_Console$summarizeTodos(
			_elm_lang$core$List$reverse(_p25));
		var todoStats = function () {
			var _p20 = _elm_lang$core$List$length(_p25);
			if (_p20 === 0) {
				return _exercism$elm$Console_Text$plain('');
			} else {
				return A2(
					_exercism$elm$Test_Reporter_Console$stat,
					'Todo:     ',
		...
		var headlineResult = function () {
			var _p21 = {
				...
				_0: autoFail,
				_1: _p24,
				_2: _elm_lang$core$List$length(_p25)
			};
			_v8_4:
			do {
				if (_p21._0.ctor === 'Nothing') {
					if (_p21._1 === 0) {
						switch (_p21._2) {
							...
							case 1:
								return _elm_lang$core$Result$Err(
									{ctor: '_Tuple3', _0: _exercism$elm$Console_Text$yellow, _1: 'TEST RUN INCOMPLETE', _2: ' because there is 1 TODO remaining'});
							default:
								return _elm_lang$core$Result$Err(
									{
										ctor: '_Tuple3',
										_0: _exercism$elm$Console_Text$yellow,
										...
										_2: A2(
											...
											A2(
												_elm_lang$core$Basics_ops['++'],
												_elm_lang$core$Basics$toString(_p21._2),
												' TODOs remaining'))
									});
						}
					} else {
						...
						return _elm_lang$core$Result$Err(
							{
								...
								_0: _exercism$elm$Console_Text$yellow,
								_1: 'TEST RUN INCOMPLETE',
								_2: A2(_elm_lang$core$Basics_ops['++'], ' because ', _p21._0._0)
							});
					} else {
						break _v8_4;
					}
			...
			return _elm_lang$core$Result$Err(
				{ctor: '_Tuple3', _0: _exercism$elm$Console_Text$red, _1: 'TEST RUN FAILED', _2: ''});
		}();
		var headline = function () {
			var _p22 = headlineResult;
			if (_p22.ctor === 'Ok') {
				return _exercism$elm$Console_Text$underline(
					_exercism$elm$Console_Text$green(
						A2(
							_elm_lang$core$Basics_ops['++'],
							'\n',
				...
				return _exercism$elm$Console_Text$concat(
					{
						ctor: '::',
						_0: _exercism$elm$Console_Text$underline(
							_p23(
								A2(_elm_lang$core$Basics_ops['++'], '\n', _p22._0._1))),
						_1: {
							ctor: '::',
							_0: _p23(
								A2(_elm_lang$core$Basics_ops['++'], _p22._0._2, '\n\n')),
							_1: {ctor: '[]'}
						}
					});
			}
		...
		return _elm_lang$core$Json_Encode$string(
			A2(
				_exercism$elm$Console_Text$render,
				useColor,
				_exercism$elm$Console_Text$concat(
					{
						ctor: '::',
						_0: headline,
						_1: {
							...
							_0: A2(
								_exercism$elm$Test_Reporter_Console$stat,
								'Duration: ',
								_exercism$elm$Test_Reporter_Console$formatDuration(_p19.duration)),
							_1: {
								ctor: '::',
								_0: A2(
									_exercism$elm$Test_Reporter_Console$stat,
									'Passed:   ',
									_elm_lang$core$Basics$toString(_p19.passed)),
								_1: {
									ctor: '::',
									_0: A2(
										_exercism$elm$Test_Reporter_Console$stat,
...
var _exercism$elm$Test_Reporter_JUnit$formatFailure = function (_p1) {
	var _p2 = _p1;
	var _p4 = _p2.message;
	var _p3 = _p2.given;
	if (_p3.ctor === 'Just') {
...
var _exercism$elm$Test_Reporter_JUnit$encodeFailureTuple = function (message) {
	return {
		ctor: '_Tuple2',
		_0: 'failure',
...
var _exercism$elm$Test_Reporter_JUnit$encodeOutcome = function (outcome) {
	var _p5 = outcome;
	switch (_p5.ctor) {
		case 'Passed':
			return {ctor: '[]'};
		case 'Failed':
			var message = A2(
				_elm_lang$core$String$join,
				'\n\n\n',
				A2(_elm_lang$core$List$map, _exercism$elm$Test_Reporter_JUnit$formatFailure, _p5._0));
			return {
				ctor: '::',
				_0: _exercism$elm$Test_Reporter_JUnit$encodeFailureTuple(message),
				_1: {ctor: '[]'}
			};
		default:
			return {
				ctor: '::',
				_0: _exercism$elm$Test_Reporter_JUnit$encodeFailureTuple(
					A2(_elm_lang$core$Basics_ops['++'], 'TODO: ', _p5._0)),
				_1: {ctor: '[]'}
			};
	}
};
var _exercism$elm$Test_Reporter_JUnit$reportComplete = function (_p6) {
	var _p7 = _p6;
	var _p8 = _exercism$elm$Test_Reporter_JUnit$formatClassAndName(_p7.labels);
				...
				_1: {
					...
					_1: {
						...
						_0: {
							ctor: '_Tuple2',
							_0: '@time',
							_1: _exercism$elm$Test_Reporter_JUnit$encodeTime(_p7.duration)
						},
						_1: {ctor: '[]'}
					}
				}
			},
			_exercism$elm$Test_Reporter_JUnit$encodeOutcome(_p7.outcome)));
};
var _exercism$elm$Test_Reporter_JUnit$encodeExtraFailure = function (failure) {
	return _exercism$elm$Test_Reporter_JUnit$reportComplete(
		{
			labels: {ctor: '[]'},
			duration: 0,
			outcome: _exercism$elm$Test_Reporter_TestResults$Failed(
				{ctor: '[]'})
		});
};
var _exercism$elm$Test_Reporter_JUnit$reportSummary = F2(
	function (_p9, autoFail) {
		...
		var extraFailures = function () {
			...
			if (((_p11.ctor === '_Tuple2') && (_p11._0 === 0)) && (_p11._1.ctor === 'Just')) {
				return {
					ctor: '::',
					_0: _exercism$elm$Test_Reporter_JUnit$encodeExtraFailure(_p11._1._0),
					_1: {ctor: '[]'}
				};
			} else {
				return {ctor: '[]'};
...
var _exercism$elm$Test_Reporter_JUnit$reportBegin = function (_p13) {
	return _elm_lang$core$Maybe$Nothing;
};
...
var _exercism$elm$Test_Runner_Node$init = function (_p0) {
	var _p1 = _p0;
	var testReporter = _exercism$elm$Test_Reporter_Reporter$createReporter(_p1.report);
	var _p2 = function () {
		var _p3 = _p1.runners;
		switch (_p3.ctor) {
			case 'Plain':
...
var _exercism$elm$Test_Runner_Node$countFailures = F2(
...
var _exercism$elm$Test_Runner_Node$receive = _elm_lang$core$Native_Platform.incomingPort('receive', _elm_lang$core$Json_Decode$value);
var _exercism$elm$Test_Runner_Node$send = _elm_lang$core$Native_Platform.outgoingPort(
	'send',
	function (v) {
		return v;
	});
var _exercism$elm$Test_Runner_Node$sendResults = F3(
	function (isFinished, testReporter, results) {
		...
		return _exercism$elm$Test_Runner_Node$send(
			A2(
...
var _exercism$elm$Test_Runner_Node$sendBegin = function (model) {
...
var _exercism$elm$Test_Runner_Node$Model = F7(
	function (a, b, c, d, e, f, g) {
		return {available: a, runInfo: b, testReporter: c, results: d, processes: e, nextTestToRun: f, autoFail: g};
	});
var _exercism$elm$Test_Runner_Node$Complete = F4(
	function (a, b, c, d) {
		return {ctor: 'Complete', _0: a, _1: b, _2: c, _3: d};
	});
var _exercism$elm$Test_Runner_Node$dispatch = F2(
	function (model, startTime) {
		var _p11 = A2(_elm_lang$core$Dict$get, model.nextTestToRun, model.available);
		if (_p11.ctor === 'Nothing') {
			return A3(_exercism$elm$Test_Runner_Node$sendResults, true, model.testReporter, model.results);
		} else {
			var outcomes = _exercism$elm$Test_Reporter_TestResults$outcomesFromExpectations(
				_exercism$elm$Test_Runner_Node$runThunk(_p11._0.run));
			return A2(
				_elm_lang$core$Task$perform,
				A3(_exercism$elm$Test_Runner_Node$Complete, _p11._0.labels, outcomes, startTime),
				_elm_lang$core$Time$now);
		}
	});
...
var _exercism$elm$Test_Runner_Node$update = F2(
	function (msg, _p12) {
		var _p13 = _p12;
		...
		switch (_p14.ctor) {
			case 'Receive':
				var _p15 = A2(_elm_lang$core$Json_Decode$decodeValue, _exercism$elm$Test_Runner_JsMessage$decoder, _p14._0);
				if (_p15.ctor === 'Ok') {
					if (_p15._0.ctor === 'Summary') {
						...
						var cmd = _exercism$elm$Test_Runner_Node$send(
							A2(
								_elm_lang$core$Json_Encode$encode,
								0,
								_elm_lang$core$Json_Encode$object(
						...
						var _p18 = _p15._0._0;
						var cmd = A2(_elm_lang$core$Task$perform, _exercism$elm$Test_Runner_Node$Dispatch, _elm_lang$core$Time$now);
							...
							_1: _elm_lang$core$Platform_Cmd$batch(
								{
									...
									_1: {
										ctor: '::',
										_0: _exercism$elm$Test_Runner_Node$sendBegin(_p20),
										_1: {ctor: '[]'}
									}
								})
						} : {
			...
			case 'Dispatch':
				return {
					ctor: '_Tuple2',
					_0: _p20,
					_1: A2(_exercism$elm$Test_Runner_Node$dispatch, _p20, _p14._0)
				};
			default:
				var _p19 = _p14._1;
				...
				if (isFinished || A2(_elm_lang$core$List$any, _exercism$elm$Test_Reporter_TestResults$isFailure, _p19)) {
					var cmd = A3(_exercism$elm$Test_Runner_Node$sendResults, isFinished, _p21, results);
						...
						_1: _elm_lang$core$Platform_Cmd$batch(
							{
								...
								_1: {
									ctor: '::',
									_0: A2(_elm_lang$core$Task$perform, _exercism$elm$Test_Runner_Node$Dispatch, _elm_lang$core$Time$now),
									_1: {ctor: '[]'}
								}
							})
					};
					...
					return {
						...
						_1: A2(_elm_lang$core$Task$perform, _exercism$elm$Test_Runner_Node$Dispatch, _elm_lang$core$Time$now)
					};
				}
		}
	});
var _exercism$elm$Test_Runner_Node$Receive = function (a) {
	return {ctor: 'Receive', _0: a};
};
var _exercism$elm$Test_Runner_Node$runWithOptions = function (options) {
	return A2(
		_exercism$elm$Test_Runner_Node_App$run,
		options,
		{
			init: _exercism$elm$Test_Runner_Node$init,
			update: _exercism$elm$Test_Runner_Node$update,
			subscriptions: function (_p22) {
				return _exercism$elm$Test_Runner_Node$receive(_exercism$elm$Test_Runner_Node$Receive);
			}
		});
};

var _exercism$elm$Test_Generated_Main888624137$main = A2(
	_exercism$elm$Test_Runner_Node$runWithOptions,
	{
		runs: _elm_lang$core$Maybe$Nothing,
		report: _exercism$elm$Test_Reporter_Reporter$ConsoleReport(_exercism$elm$Console_Text$UseColor),
...
Elm['Test']['Generated']['Main888624137'] = Elm['Test']['Generated']['Main888624137'] || {};
if (typeof _exercism$elm$Test_Generated_Main888624137$main !== 'undefined') {
    _exercism$elm$Test_Generated_Main888624137$main(Elm['Test']['Generated']['Main888624137'], 'Test.Generated.Main888624137', undefined);
}
